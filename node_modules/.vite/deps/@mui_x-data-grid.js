...
var _excluded32 = ["item", "applyValue", "type", "apiRef", "focusElementRef", "tabIndex", "disabled", "headerFilterMenu", "isFilterActive", "clearButton", "InputProps"];
...
true ? GridFilterInputValue.propTypes = {
  ...
  headerFilterMenu: import_prop_types38.default.node,
  /**
...
var _excluded33 = ["item", "applyValue", "type", "apiRef", "focusElementRef", "InputProps", "headerFilterMenu", "isFilterActive", "clearButton", "tabIndex", "disabled"];
...
true ? GridFilterInputDate.propTypes = {
  ...
  headerFilterMenu: import_prop_types39.default.node,
  /**
   * It is `true` if the filter either has a value or an operator with no value
   * required is selected (e.g. `isEmpty`)
   */
...
var _excluded34 = ["item", "applyValue", "type", "apiRef", "focusElementRef", "getOptionLabel", "getOptionValue", "placeholder", "tabIndex", "label", "headerFilterMenu", "isFilterActive", "clearButton"];
...
true ? GridFilterInputSingleSelect.propTypes = {
  ...
  headerFilterMenu: import_prop_types40.default.node,
  /**
   * It is `true` if the filter either has a value or an operator with no value
   * required is selected (e.g. `isEmpty`)
   */
...
var _excluded35 = ["item", "applyValue", "apiRef", "focusElementRef", "headerFilterMenu", "isFilterActive", "clearButton", "tabIndex", "label"];
...
function GridFilterInputBoolean(props) {
  ...
  const [filterValueState, setFilterValueState] = React61.useState(item.value || "");
  const rootProps = useGridRootProps();
  const labelId = useId();
...
true ? GridFilterInputBoolean.propTypes = {
  ...
  headerFilterMenu: import_prop_types41.default.node,
  /**
   * It is `true` if the filter either has a value or an operator with no value
   * required is selected (e.g. `isEmpty`)
   */
...
var GridFilterPanel = React62.forwardRef(function GridFilterPanel2(props, ref) {
  ...
  const placeholderFilter = React62.useRef(null);
  const {
    logicOperators = [GridLogicOperator.And, GridLogicOperator.Or],
    columnsSort,
    filterFormProps,
...
var useGridFocus = (apiRef, props) => {
  ...
  const setColumnHeaderFilterFocus = React101.useCallback((field, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    publishCellFocusOut(cell, event);
    apiRef.current.setState((state) => {
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const goToHeaderFilter = React102.useCallback((colIndex, event) => {
  ...
  const handleHeaderFilterKeyDown = React102.useCallback((params, event) => {
    const dimensions = apiRef.current.getRootDimensions();
    if (!dimensions) {
      return;
    }
...
function useProps(allProps) {
  return React124.useMemo(() => {
    const {
      components,
      componentsProps
    } = allProps, themedProps = _objectWithoutPropertiesLoose(allProps, _excluded58);
...
var useGridColumnGrouping = (apiRef, props) => {
  ...
  const updateColumnGroupingState = React129.useCallback((columnGroupingModel) => {
