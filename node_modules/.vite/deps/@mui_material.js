...
var Snackbar = React77.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime87.jsx)(ClickAwayListener_default, _extends({
    onClickAway
  }, ClickAwayListenerProps, {
...
var Tabs = React107.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [displayScroll, setDisplayScroll] = React107.useState({
    start: false,
    end: false
  });
  ...
  const handleTabsScroll = React107.useMemo(() => debounce_default(() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  React107.useEffect(() => {
    return () => {
